...
<section class="container" id="content">
  <div class="row mt-3 mb-3">
    <article class="col-sm-8">
      ...
      <?php endwhile;  the_post_navigation(array('prev_text' => '<span class="fa fa-long-arrow-left"></span>','next_text' => '<span class="fa fa-long-arrow-right"></span>'));   else: ?>
        <h4><?php esc_html_e('There are no posts or pages here','cool-web') ?></h4>
      <?php endif; ?>
    </article>
